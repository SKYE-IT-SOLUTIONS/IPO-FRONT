import { CardContent, Container, Divider, Grid, TextField, Typography } from '@mui/material';
    ...
    <Container component="main" maxWidth="md" >
            ...
            >
              <Grid
                ...
                sm={12}
              >
                <Divider><Typography variant="h5" >Personal Details</Typography></Divider>
              </Grid>
            </Grid>
            ...
            <CardContent>
              ...
              <Grid item md={12} xs={12}>
                ...
                sm={12}
              >
                <Divider><Typography variant="h5" >Guardian Details</Typography></Divider>
              </Grid>
              <Grid item md={6} xs={12}>
                  <TextField
