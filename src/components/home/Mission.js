        ...
        <Container>
          <Row>
            ...
            <Col lg={5} md={7} sm={10} xs={10}>
              <Title>Mission</Title>
              <Para>
                Educate and support students as they explore and introspect to
                decide prudent career pathways, gain valuable experience,
                develop professionalism, and embark on their post-graduation
                career plans as global citizens
                <br />
              </Para>
            </Col>
