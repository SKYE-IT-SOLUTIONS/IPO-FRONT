...
function Register() {
  ...
  return (
    <div>
      <Header>
        <AnimatedText font={fonts}>Choose Your character</AnimatedText>
      </Header>
      <Mdiv font={fonts}>
          ...
          <Row>
            ...
            <Col>
              <Paper
                ...
                onClick={() => {
                  navigate("studentReg")
                  if (false) {//todo:this condition must be coming from the backend
