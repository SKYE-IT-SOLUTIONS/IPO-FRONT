...
function ThemeContextProvider(props) {
  ...
  const dark = { syntax: "#000", ui: "linear-gradient(to right, #000428, #004e92)", bg: "#555", color: "blue", footer:{syntax:"#fff",f_ic_bg:"#212529", f_c_bg:"rgba(0,0,0,0.2)", copyright:"#ffffff99"} };
